<template>
  <div id="courseManage">
    <div class="info-top">
      <p>
        <i class="el-icon-info"></i>温馨提示：您可以在这里操作课程数据
      </p>
    </div>
    <div class="table-wrapper">
      <div class="table-top">
        <el-input v-model="inputName" placeholder="请输入课程名"></el-input>

        <el-select v-model="valueKind" placeholder="请选择类型">
          <el-option
            v-for="item in optionKind"
            :key="item.value"
            :label="item.label"
            :value="item.value"
          ></el-option>
      ...
      <div class="table-main">
        ...
        >
          ...
          <el-table-column align="center" prop="date" label="注册日期" sortable width="120"></el-table-column>
          <el-table-column align="center" prop="name" label="姓名" width="100"></el-table-column>
          <el-table-column align="center" prop="nickname" label="昵称" width="90"></el-table-column>
          <el-table-column align="center" prop="sex" label="性别" width="70"></el-table-column>
          ...
          <el-table-column align="center" prop="phone" label="手机" width="117"></el-table-column>
          <el-table-column align="center" prop="qq" label="QQ" width="110"></el-table-column>
          <el-table-column align="center" label="用户类型" width="80">
            <template slot-scope="scope">
              <el-tag v-if="scope.row.userKind == '普通'">普通</el-tag>
              <el-tag v-else-if="scope.row.userKind == '会员'" type="warning">会员</el-tag>
            </template>
          </el-table-column>
